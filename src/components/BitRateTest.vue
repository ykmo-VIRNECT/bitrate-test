  ...
  <div>
    ...
    <div>
      <fieldset>
        ...
        <button @click="setRecordType($event, 'MediaStreamRecorder')">
          MediaStreamRecorder
        </button>
        <button @click="setRecordType($event, 'StereoAudioRecorder')">
          StereoAudioRecorder
        </button>
        <button @click="setRecordType($event, 'WebAssemblyRecorder')">
          WebAssemblyRecorder
        </button>
        <button @click="setRecordType($event, 'CanvasRecorder')">
          CanvasRecorder
        </button>
        <button @click="setRecordType($event, 'GifRecorder')">
          GifRecorder
        </button>
        <button @click="setRecordType($event, 'WhammyRecorder')">
          WhammyRecorder
        </button>
        <br />
        <button @click="testMultiStreamRecorder($event, 'MultiStreamRecorder')">
          MultiStreamRecorder
        </button>
      </fieldset>
      <fieldset>
      ...
      <fieldset>
        ...
        <button @click="startRecordSaveChunk()">
          CLIENT - start timeSliceMode And Devided Chunk
        </button>
        <button
          @click="startRecord($event, (timeslice = true), (sendServer = false))"
        >
          CLIENT - start timeSliceMode And Merge Chunk
        </button>
        <button
          @click="startRecord($event, (timeslice = true), (sendServer = true))"
        >
          SERVER - start timeSliceMode And Merge Chunk
        </button>
        timeslice ms
      ...
      <fieldset>
        <legend>Stop</legend>
        <button @click="stopRecord($event, (timeslice = false))">
          stop record
        </button>
        <button @click="stopRecord($event, (timeslice = true))">
          stop timeSliceMode
        </button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      testMultiStreamRecorder() {
        let multiStreamRecorder;
		console.log(this.stream);
		console.log(MSR.MultiStreamRecorder)
        multiStreamRecorder = new MSR(this.stream);

		console.log(RecordRTC.invokeSaveAsDialog)
